...
public class CarwashOfflineActivity extends AppCompatActivity {
    ...
    private Response.ErrorListener errorListener = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError volleyError) {
            ...
            Toast.makeText(CarwashOfflineActivity.this, "Ошибка", Toast.LENGTH_SHORT).show();
        }
    };
        ...
        public void onResponse(AddOrderPojo addOrderPojo) {
            ...
            try {
                if (addOrderPojo.getData().getOrderStatusId().equals("-1")) {
                    ...
                    Toast.makeText(CarwashOfflineActivity.this, "Нельзя записать на это время", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CarwashOfflineActivity.this, "Ошибка", Toast.LENGTH_SHORT).show();
...
//        cal.add(Calendar.DAY_OF_MONTH, 5);
    ...
    public void addOrder() {
        if (validateData() == false) {
            Toast.makeText(CarwashOfflineActivity.this, "Заполните все данные", Toast.LENGTH_SHORT).show();
        } else {
            ...
            orderData.put("access_token", MyPreferences.getUserPushToken(CarwashOfflineActivity.this));
    ...
    public void getServices() {
        ...
        if (carCategoryId.length() < 1) {
            Toast.makeText(CarwashOfflineActivity.this, "Сначала выберите машину", Toast.LENGTH_SHORT).show();
        } else {
